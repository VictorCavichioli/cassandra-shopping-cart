...
public class ProductOfferingService {
    ...
    public ProductOffering insert(ProductOffering productOffering){
        productOffering.setId(UUID.randomUUID());
    ...
    public ResponseEntity<ProductOffering> update(UUID productOfferingId, Map<String, Object> fieldsToUpdate){
        ...
        fieldsToUpdate.forEach((key, value) -> {
            switch (key) {
                case "name":
                    productOffering.setName((String) value);
                    break;
                case "price":
                    productOffering.setPrice((Double) value);
                    break;
                case "validate":
                    productOffering.setValidate((LocalDate) value);
                    break;
                default:
